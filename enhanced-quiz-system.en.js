...
(function() {
    ...
    function createResultPopup() {
        ...
        popup.innerHTML = `
            <div class="quiz-popup-content">
                ...
                <div class="quiz-popup-message" id="quiz-popup-message">Reread the module.</div>
                <div class="quiz-popup-buttons">
                    <button class="quiz-popup-btn quiz-popup-continue" id="quiz-popup-continue">Continue</button>
                    <button class="quiz-popup-btn quiz-popup-retry" id="quiz-popup-retry" style="display:none;">Retake</button>
                </div>
            </div>
        `;
    ...
    function showResultPopup(isCorrect) {
        ...
        if (quizState.answeredQuizzes === quizState.totalQuizzes) {
            ...
            if (percentage >= 80) {
                messageEl.textContent = 'Excellent! You are ready for the next module.';
                scoreEl.style.color = '#10b981';
            } else if (percentage >= 60) {
                messageEl.textContent = 'Good! But there is room for improvement.';
                scoreEl.style.color = '#f59e0b';
            } else {
                messageEl.textContent = 'Reread the module.';
