    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 14, fontWeight: 800, color: '#111827' }}>{truck.driver}</div>
            ...
            <div key={i} style={{
              ...
              <div style={{
                ...
                background: m.from === 'dispatcher'
                  ...
                  : '#f3f4f6',
                border: `1px solid ${m.from === 'dispatcher' ? 'rgba(10,132,255,0.3)' : 'rgba(0,0,0,0.06)'}`,
                borderBottomRightRadius: m.from === 'dispatcher' ? 4 : 16,
                borderBottomLeftRadius: m.from === 'driver' ? 4 : 16,
              }}>
                <div style={{ fontSize: 13, color: '#374151', lineHeight: 1.4 }}>{m.text}</div>
                <div style={{ fontSize: 9, color: '#6b7280', marginTop: 3, textAlign: 'right' } as any}>{m.time}</div>
              </div>
            </div>
          ))}
          {typing && (
        ...
        `}</style>
        <div style={{ borderTop: '1px solid rgba(0,0,0,0.06)', padding: '6px 0 8px' } as any}>
