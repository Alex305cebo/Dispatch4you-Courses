          ...
          <View style={styles.statsCard}>
            ...
            <View style={styles.statRow}>
              ...
              <Text style={[styles.statValue, { 
                color: reputation > 70 ? T.success : reputation > 40 ? T.warning : T.danger 
              }]}>
                {reputation}%
              </Text>
            </View>
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  item.isGuide && {
                    ...
                    borderColor: guideActive ? 'rgba(99,102,241,0.4)' : 'rgba(99,102,241,0.2)',
                    marginBottom: 14,
                  },
                ]}
                onPress={item.action}
                ...
                <View style={styles.menuItemContent}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={[
                      ...
                      item.isGuide && { color: '#4f46e5', fontWeight: '800' },
                    ]}>
                      {item.label}
                    </Text>
                    {item.isGuide && (
