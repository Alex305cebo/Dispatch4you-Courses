      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 900, color: '#111827' }}>{broker.name}</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: '#6b7280' }}>🤝 Relationship</span>
            <span style={{ fontSize: 13, fontWeight: 800, color: relColor }}>{relLabel} · {broker.relationship}%</span>
          </div>
          <div style={{
            height: 8, borderRadius: 4, background: 'rgba(0,0,0,0.06)',
            overflow: 'hidden',
          }}>
            <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 14 }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ fontSize: 10, color: '#6b7280', fontWeight: 600, marginBottom: 4 }}>{s.icon} {s.label}</div>
        ...
        {recentComms.length > 0 && (
          <div>
            <div style={{ fontSize: 12, fontWeight: 800, color: '#6b7280', marginBottom: 8 }}>📧 Recent Messages</div>
            {recentComms.map((n, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: 11, fontWeight: 700, color: '#111827' }}>{n.subject}</div>
