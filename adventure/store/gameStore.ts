...
function generateLoads(minute: number): LoadOffer[] {
  ...
  const routes = [
    ...
    { from: 'New Orleans', to: 'Denver',         miles: 1300 },
    { from: 'New Orleans', to: 'Phoenix',        miles: 1500 },
    { from: 'New Orleans', to: 'Seattle',        miles: 2600 },
    { from: 'New Orleans', to: 'New York',       miles: 1330 },
    { from: 'New Orleans', to: 'Philadelphia',   miles: 1250 },
    { from: 'New Orleans', to: 'Boston',         miles: 1550 },
    // ── ADDITIONAL CROSS-COUNTRY ROUTES ──
    { from: 'Portland', to: 'Chicago',           miles: 2150 },
    { from: 'Portland', to: 'Dallas',            miles: 2200 },
    { from: 'Portland', to: 'Houston',           miles: 2400 },
    { from: 'Portland', to: 'Atlanta',           miles: 2700 },
    { from: 'Portland', to: 'New York',          miles: 2900 },
    { from: 'Portland', to: 'Miami',             miles: 3100 },
    { from: 'Portland', to: 'Denver',            miles: 1400 },
    { from: 'Portland', to: 'Phoenix',           miles: 1500 },
    { from: 'Portland', to: 'Los Angeles',       miles: 960  },
    { from: 'Portland', to: 'Salt Lake City',    miles: 770  },
    { from: 'Portland', to: 'Las Vegas',         miles: 1050 },
    { from: 'Portland', to: 'Kansas City',       miles: 1850 },
    { from: 'Portland', to: 'Minneapolis',       miles: 1750 },
    { from: 'Portland', to: 'Nashville',         miles: 2300 },
    { from: 'Portland', to: 'Memphis',           miles: 2200 },
    { from: 'Portland', to: 'Charlotte',         miles: 2750 },
    { from: 'Portland', to: 'Philadelphia',      miles: 2900 },
    { from: 'Portland', to: 'Boston',            miles: 3050 },
    // ── REVERSE ROUTES (важно для баланса) ──
    { from: 'Houston', to: 'Portland',           miles: 2400 },
    { from: 'Dallas', to: 'Portland',            miles: 2200 },
    { from: 'Chicago', to: 'Portland',           miles: 2150 },
    { from: 'Atlanta', to: 'Portland',           miles: 2700 },
    { from: 'New York', to: 'Portland',          miles: 2900 },
    { from: 'Miami', to: 'Portland',             miles: 3100 },
    { from: 'Denver', to: 'Portland',            miles: 1400 },
    { from: 'Phoenix', to: 'Portland',           miles: 1500 },
    { from: 'Los Angeles', to: 'Portland',       miles: 960  },
    { from: 'Seattle', to: 'Portland',           miles: 175  },
    { from: 'Salt Lake City', to: 'Portland',    miles: 770  },
    { from: 'Las Vegas', to: 'Portland',         miles: 1050 },
    { from: 'Kansas City', to: 'Portland',       miles: 1850 },
    { from: 'Minneapolis', to: 'Portland',       miles: 1750 },
    { from: 'Nashville', to: 'Portland',         miles: 2300 },
    { from: 'Memphis', to: 'Portland',           miles: 2200 },
    { from: 'Charlotte', to: 'Portland',         miles: 2750 },
    { from: 'Philadelphia', to: 'Portland',      miles: 2900 },
    { from: 'Boston', to: 'Portland',            miles: 3050 },
    // ── MORE LONG-HAUL ROUTES ──
    { from: 'Boston', to: 'Los Angeles',         miles: 3000 },
    { from: 'Boston', to: 'San Francisco',       miles: 3100 },
    { from: 'Boston', to: 'Seattle',             miles: 3050 },
    { from: 'Boston', to: 'Phoenix',             miles: 2400 },
    { from: 'Boston', to: 'Denver',              miles: 1990 },
    { from: 'Boston', to: 'Houston',             miles: 1830 },
    { from: 'Boston', to: 'Las Vegas',           miles: 2750 },
    { from: 'Boston', to: 'Portland',            miles: 3050 },
    { from: 'Boston', to: 'Salt Lake City',      miles: 2400 },
    { from: 'Boston', to: 'Kansas City',         miles: 1400 },
    { from: 'Boston', to: 'Minneapolis',         miles: 1400 },
    { from: 'Boston', to: 'Memphis',             miles: 1300 },
    { from: 'Boston', to: 'New Orleans',         miles: 1550 },
    { from: 'Philadelphia', to: 'Los Angeles',   miles: 2750 },
    { from: 'Philadelphia', to: 'San Francisco', miles: 2900 },
    { from: 'Philadelphia', to: 'Seattle',       miles: 2850 },
    { from: 'Philadelphia', to: 'Phoenix',       miles: 2300 },
    { from: 'Philadelphia', to: 'Denver',        miles: 1700 },
    { from: 'Philadelphia', to: 'Houston',       miles: 1550 },
    { from: 'Philadelphia', to: 'Las Vegas',     miles: 2500 },
    { from: 'Philadelphia', to: 'Portland',      miles: 2900 },
    { from: 'Philadelphia', to: 'Salt Lake City',miles: 2200 },
    { from: 'Philadelphia', to: 'Kansas City',   miles: 1150 },
    { from: 'Philadelphia', to: 'Minneapolis',   miles: 1150 },
    { from: 'Philadelphia', to: 'Memphis',       miles: 1050 },
    { from: 'Philadelphia', to: 'New Orleans',   miles: 1250 },
    { from: 'Philadelphia', to: 'Detroit',       miles: 500  },
    { from: 'Philadelphia', to: 'Indianapolis',  miles: 650  },
    { from: 'Philadelphia', to: 'St. Louis',     miles: 900  },
    // ── REVERSE LONG-HAUL ──
    { from: 'Los Angeles', to: 'Boston',         miles: 3000 },
    { from: 'San Francisco', to: 'Boston',       miles: 3100 },
    { from: 'Seattle', to: 'Boston',             miles: 3050 },
    { from: 'Phoenix', to: 'Boston',             miles: 2400 },
    { from: 'Denver', to: 'Boston',              miles: 1990 },
    { from: 'Houston', to: 'Boston',             miles: 1830 },
    { from: 'Las Vegas', to: 'Boston',           miles: 2750 },
    { from: 'Salt Lake City', to: 'Boston',      miles: 2400 },
    { from: 'Kansas City', to: 'Boston',         miles: 1400 },
    { from: 'Minneapolis', to: 'Boston',         miles: 1400 },
    { from: 'Memphis', to: 'Boston',             miles: 1300 },
    { from: 'New Orleans', to: 'Boston',         miles: 1550 },
    { from: 'Los Angeles', to: 'Philadelphia',   miles: 2750 },
    { from: 'San Francisco', to: 'Philadelphia', miles: 2900 },
    { from: 'Seattle', to: 'Philadelphia',       miles: 2850 },
    { from: 'Phoenix', to: 'Philadelphia',       miles: 2300 },
    { from: 'Denver', to: 'Philadelphia',        miles: 1700 },
    { from: 'Houston', to: 'Philadelphia',       miles: 1550 },
    { from: 'Las Vegas', to: 'Philadelphia',     miles: 2500 },
    { from: 'Salt Lake City', to: 'Philadelphia',miles: 2200 },
    { from: 'Kansas City', to: 'Philadelphia',   miles: 1150 },
    { from: 'Minneapolis', to: 'Philadelphia',   miles: 1150 },
    { from: 'Memphis', to: 'Philadelphia',       miles: 1050 },
    { from: 'Detroit', to: 'Philadelphia',       miles: 500  },
    { from: 'Indianapolis', to: 'Philadelphia',  miles: 650  },
    { from: 'St. Louis', to: 'Philadelphia',     miles: 900  },
    // ── ADDITIONAL MIDWEST ROUTES ──
    { from: 'Minneapolis', to: 'Houston',        miles: 1400 },
    { from: 'Minneapolis', to: 'Miami',          miles: 1900 },
    { from: 'Minneapolis', to: 'Phoenix',        miles: 1650 },
    { from: 'Minneapolis', to: 'Las Vegas',      miles: 1550 },
    { from: 'Minneapolis', to: 'Salt Lake City', miles: 1250 },
    { from: 'Minneapolis', to: 'San Francisco',  miles: 1900 },
    { from: 'Minneapolis', to: 'Portland',       miles: 1750 },
    { from: 'Minneapolis', to: 'Nashville',      miles: 900  },
    { from: 'Minneapolis', to: 'Memphis',        miles: 850  },
    { from: 'Minneapolis', to: 'New Orleans',    miles: 1300 },
    { from: 'Minneapolis', to: 'Charlotte',      miles: 1200 },
    { from: 'Minneapolis', to: 'Philadelphia',   miles: 1150 },
    { from: 'Minneapolis', to: 'Boston',         miles: 1400 },
    { from: 'Minneapolis', to: 'Columbus',       miles: 750  },
    { from: 'Minneapolis', to: 'Indianapolis',   miles: 600  },
    { from: 'Minneapolis', to: 'St. Louis',      miles: 560  },
    // ── ADDITIONAL SOUTH ROUTES ──
    { from: 'Jacksonville', to: 'Los Angeles',   miles: 2400 },
    { from: 'Jacksonville', to: 'San Francisco', miles: 2650 },
    { from: 'Jacksonville', to: 'Seattle',       miles: 2900 },
    { from: 'Jacksonville', to: 'Denver',        miles: 1800 },
    { from: 'Jacksonville', to: 'Phoenix',       miles: 1900 },
    { from: 'Jacksonville', to: 'Las Vegas',     miles: 2200 },
    { from: 'Jacksonville', to: 'Salt Lake City',miles: 2100 },
    { from: 'Jacksonville', to: 'Kansas City',   miles: 1100 },
    { from: 'Jacksonville', to: 'Minneapolis',   miles: 1400 },
    { from: 'Jacksonville', to: 'Memphis',       miles: 700  },
    { from: 'Jacksonville', to: 'Charlotte',     miles: 400  },
    { from: 'Jacksonville', to: 'Philadelphia',  miles: 900  },
    { from: 'Jacksonville', to: 'Boston',        miles: 1150 },
    { from: 'Jacksonville', to: 'Detroit',       miles: 1050 },
    { from: 'Jacksonville', to: 'Columbus',      miles: 850  },
    { from: 'Jacksonville', to: 'Indianapolis',  miles: 900  },
    { from: 'Tampa', to: 'Los Angeles',          miles: 2500 },
    { from: 'Tampa', to: 'San Francisco',        miles: 2750 },
    { from: 'Tampa', to: 'Seattle',              miles: 3000 },
    { from: 'Tampa', to: 'Denver',               miles: 1900 },
    { from: 'Tampa', to: 'Phoenix',              miles: 1900 },
    { from: 'Tampa', to: 'Las Vegas',            miles: 2300 },
    { from: 'Tampa', to: 'Salt Lake City',       miles: 2200 },
    { from: 'Tampa', to: 'Kansas City',          miles: 1200 },
    { from: 'Tampa', to: 'Minneapolis',          miles: 1500 },
    { from: 'Tampa', to: 'Memphis',              miles: 800  },
    { from: 'Tampa', to: 'Nashville',            miles: 850  },
    { from: 'Tampa', to: 'Charlotte',            miles: 550  },
    { from: 'Tampa', to: 'Philadelphia',         miles: 1050 },
    { from: 'Tampa', to: 'Boston',               miles: 1350 },
    { from: 'Tampa', to: 'Detroit',              miles: 1250 },
    { from: 'Tampa', to: 'Columbus',             miles: 1050 },
    { from: 'Tampa', to: 'Indianapolis',         miles: 1050 },
    { from: 'Tampa', to: 'New Orleans',          miles: 550  },
    // ── REVERSE FLORIDA ROUTES ──
    { from: 'Los Angeles', to: 'Jacksonville',   miles: 2400 },
    { from: 'San Francisco', to: 'Jacksonville', miles: 2650 },
    { from: 'Seattle', to: 'Jacksonville',       miles: 2900 },
    { from: 'Denver', to: 'Jacksonville',        miles: 1800 },
    { from: 'Phoenix', to: 'Jacksonville',       miles: 1900 },
    { from: 'Las Vegas', to: 'Jacksonville',     miles: 2200 },
    { from: 'Salt Lake City', to: 'Jacksonville',miles: 2100 },
    { from: 'Kansas City', to: 'Jacksonville',   miles: 1100 },
    { from: 'Minneapolis', to: 'Jacksonville',   miles: 1400 },
    { from: 'Memphis', to: 'Jacksonville',       miles: 700  },
    { from: 'Charlotte', to: 'Jacksonville',     miles: 400  },
    { from: 'Philadelphia', to: 'Jacksonville',  miles: 900  },
    { from: 'Boston', to: 'Jacksonville',        miles: 1150 },
    { from: 'Detroit', to: 'Jacksonville',       miles: 1050 },
    { from: 'Columbus', to: 'Jacksonville',      miles: 850  },
    { from: 'Indianapolis', to: 'Jacksonville',  miles: 900  },
    { from: 'Los Angeles', to: 'Tampa',          miles: 2500 },
    { from: 'San Francisco', to: 'Tampa',        miles: 2750 },
    { from: 'Seattle', to: 'Tampa',              miles: 3000 },
    { from: 'Denver', to: 'Tampa',               miles: 1900 },
    { from: 'Phoenix', to: 'Tampa',              miles: 1900 },
    { from: 'Las Vegas', to: 'Tampa',            miles: 2300 },
    { from: 'Salt Lake City', to: 'Tampa',       miles: 2200 },
    { from: 'Kansas City', to: 'Tampa',          miles: 1200 },
    { from: 'Minneapolis', to: 'Tampa',          miles: 1500 },
    { from: 'Memphis', to: 'Tampa',              miles: 800  },
    { from: 'Nashville', to: 'Tampa',            miles: 850  },
    { from: 'Charlotte', to: 'Tampa',            miles: 550  },
    { from: 'Philadelphia', to: 'Tampa',         miles: 1050 },
    { from: 'Boston', to: 'Tampa',               miles: 1350 },
    { from: 'Detroit', to: 'Tampa',              miles: 1250 },
    { from: 'Columbus', to: 'Tampa',             miles: 1050 },
    { from: 'Indianapolis', to: 'Tampa',         miles: 1050 },
    { from: 'New Orleans', to: 'Tampa',          miles: 550  },
    // ── ADDITIONAL MOUNTAIN/WEST ROUTES ──
    { from: 'Salt Lake City', to: 'Houston',     miles: 1450 },
    { from: 'Salt Lake City', to: 'Atlanta',     miles: 1900 },
    { from: 'Salt Lake City', to: 'Miami',       miles: 2600 },
    { from: 'Salt Lake City', to: 'New York',    miles: 2200 },
    { from: 'Salt Lake City', to: 'Nashville',   miles: 1650 },
    { from: 'Salt Lake City', to: 'Memphis',     miles: 1550 },
    { from: 'Salt Lake City', to: 'Kansas City', miles: 1100 },
    { from: 'Salt Lake City', to: 'Minneapolis', miles: 1250 },
    { from: 'Salt Lake City', to: 'San Francisco',miles: 750 },
    { from: 'Las Vegas', to: 'Houston',          miles: 1400 },
    { from: 'Las Vegas', to: 'Atlanta',          miles: 1900 },
    { from: 'Las Vegas', to: 'Miami',            miles: 2600 },
    { from: 'Las Vegas', to: 'New York',         miles: 2550 },
    { from: 'Las Vegas', to: 'Nashville',        miles: 1700 },
    { from: 'Las Vegas', to: 'Memphis',          miles: 1600 },
    { from: 'Las Vegas', to: 'Kansas City',      miles: 1300 },
    { from: 'Las Vegas', to: 'Minneapolis',      miles: 1550 },
    { from: 'Las Vegas', to: 'San Francisco',    miles: 570  },
    { from: 'Las Vegas', to: 'Charlotte',        miles: 2100 },
    { from: 'Las Vegas', to: 'Philadelphia',     miles: 2500 },
    { from: 'Las Vegas', to: 'Boston',           miles: 2750 },
    // ── REVERSE MOUNTAIN/WEST ──
    { from: 'Houston', to: 'Salt Lake City',     miles: 1450 },
    { from: 'Atlanta', to: 'Salt Lake City',     miles: 1900 },
    { from: 'Miami', to: 'Salt Lake City',       miles: 2600 },
    { from: 'New York', to: 'Salt Lake City',    miles: 2200 },
    { from: 'Nashville', to: 'Salt Lake City',   miles: 1650 },
    { from: 'Memphis', to: 'Salt Lake City',     miles: 1550 },
    { from: 'Kansas City', to: 'Salt Lake City', miles: 1100 },
    { from: 'Minneapolis', to: 'Salt Lake City', miles: 1250 },
    { from: 'San Francisco', to: 'Salt Lake City',miles: 750 },
    { from: 'Houston', to: 'Las Vegas',          miles: 1400 },
    { from: 'Atlanta', to: 'Las Vegas',          miles: 1900 },
    { from: 'Miami', to: 'Las Vegas',            miles: 2600 },
    { from: 'New York', to: 'Las Vegas',         miles: 2550 },
    { from: 'Nashville', to: 'Las Vegas',        miles: 1700 },
    { from: 'Memphis', to: 'Las Vegas',          miles: 1600 },
    { from: 'Kansas City', to: 'Las Vegas',      miles: 1300 },
    { from: 'Minneapolis', to: 'Las Vegas',      miles: 1550 },
    { from: 'San Francisco', to: 'Las Vegas',    miles: 570  },
    { from: 'Charlotte', to: 'Las Vegas',        miles: 2100 },
    { from: 'Philadelphia', to: 'Las Vegas',     miles: 2500 },
    { from: 'Boston', to: 'Las Vegas',           miles: 2750 },
    // ── ADDITIONAL SAN FRANCISCO ROUTES ──
    { from: 'San Francisco', to: 'Houston',      miles: 1900 },
    { from: 'San Francisco', to: 'Miami',        miles: 3000 },
    { from: 'San Francisco', to: 'Nashville',    miles: 2250 },
    { from: 'San Francisco', to: 'Memphis',      miles: 2100 },
    { from: 'San Francisco', to: 'Kansas City',  miles: 1850 },
    { from: 'San Francisco', to: 'Minneapolis',  miles: 1900 },
    { from: 'San Francisco', to: 'Charlotte',    miles: 2600 },
    { from: 'San Francisco', to: 'Detroit',      miles: 2300 },
    { from: 'San Francisco', to: 'Columbus',     miles: 2250 },
    { from: 'San Francisco', to: 'Indianapolis', miles: 2150 },
    { from: 'San Francisco', to: 'St. Louis',    miles: 2000 },
    { from: 'San Francisco', to: 'New Orleans',  miles: 2100 },
    { from: 'San Francisco', to: 'Jacksonville', miles: 2650 },
    { from: 'San Francisco', to: 'Tampa',        miles: 2750 },
    // ── REVERSE SAN FRANCISCO ──
    { from: 'Houston', to: 'San Francisco',      miles: 1900 },
    { from: 'Miami', to: 'San Francisco',        miles: 3000 },
    { from: 'Nashville', to: 'San Francisco',    miles: 2250 },
    { from: 'Memphis', to: 'San Francisco',      miles: 2100 },
    { from: 'Kansas City', to: 'San Francisco',  miles: 1850 },
    { from: 'Minneapolis', to: 'San Francisco',  miles: 1900 },
    { from: 'Charlotte', to: 'San Francisco',    miles: 2600 },
    { from: 'Detroit', to: 'San Francisco',      miles: 2300 },
    { from: 'Columbus', to: 'San Francisco',     miles: 2250 },
    { from: 'Indianapolis', to: 'San Francisco', miles: 2150 },
    { from: 'St. Louis', to: 'San Francisco',    miles: 2000 },
    { from: 'New Orleans', to: 'San Francisco',  miles: 2100 },
    { from: 'Jacksonville', to: 'San Francisco', miles: 2650 },
    { from: 'Tampa', to: 'San Francisco',        miles: 2750 },
  ];
...
case 'detention': {
  ...
  endShift: () => {
    ...
    // Если мы уже на экране shift_end — значит нажали "Новая неделя"
    if (state.phase === 'shift_end') {
      ...
      const updatedTrucks = state.trucks.map(truck => ({
        ...
        yesterdayMiles: 0, // Сбрасываем счётчик миль
      }));
      set({
        phase: 'playing',
        day: newDay,
        gameMinute: 0,
        trucks: updatedTrucks,
        totalEarned: 0, // Сбрасываем для новой недели
        totalLost: 0,
        financeLog: [],
      });
      get().saveGame();
    ...
    // Первый вызов — проверяем день недели
    const currentDay = state.day || 1;
    if (currentDay % 7 === 0) {
      // Конец недели — показываем полный отчёт
      set({ phase: 'shift_end' });
    } else {
      // Конец дня — показываем дневной отчёт
      set({ phase: 'day_end' });
    }
  },
