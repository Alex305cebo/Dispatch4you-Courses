...
(function () {
  ...
  var STUDENT_PAGES = ["pages/simulator.html","pages/load-finder.html","pages/loadboards.html","pages/amazon-relay.html","pages/amazon-relay-video.html","pages/amazon-relay-video-2.html","pages/amazon-relay-video-3.html","pages/amazon-relay-video-4.html","pages/amazon-relay-2-loads.html","pages/amazon-relay-3-problems.html","pages/amazon-relay-4-money-rating.html","pages/dispatcher-cards.html","pages/all-loads.html","pages/testing.html","pages/brokers.html","pages/cases.html","pages/communication.html","pages/equipment.html","pages/finances.html","pages/negotiation.html","pages/problems.html","pages/regulations.html","pages/routes.html","pages/technology.html","pages/role.html","pages/ai-broker-chat.html","pages/Trainer-Quiz.html","pages/lesson-tracker.html","pages/cargo-stats.html","pages/docs.html","pages/doc-module-2-complete.html","pages/doc-module-3-complete.html","pages/doc-module-4-complete.html","pages/doc-module-5-complete.html","pages/doc-module-6-complete.html","pages/doc-module-7-complete.html","pages/doc-module-8-complete.html","pages/doc-module-9-complete.html","pages/doc-module-10-complete.html","pages/doc-module-11-complete.html","pages/doc-module-12-complete.html"];
  ...
  function showPaywall(role) {
    ...
    if (isGuest) {
      d.innerHTML = "<div style='max-width:420px;width:100%;background:linear-gradient(135deg,rgba(15,23,42,.99),rgba(20,30,55,.99));border:1.5px solid rgba(6,182,212,.25);border-radius:24px;padding:36px 32px;text-align:center;box-shadow:0 25px 80px rgba(0,0,0,.7)'><div style='font-size:44px;margin-bottom:12px'>🔐</div><h2 style='font-size:22px;font-weight:800;color:#fff;margin-bottom:6px'>Sign in for access</h2><p style='font-size:13px;color:#64748b;margin-bottom:20px'>Free registration — one click</p><button onclick='window.signInWithGoogle&&window.signInWithGoogle().then(function(u){if(u)window.location.reload()})' style='width:100%;padding:13px;background:#fff;border:none;border-radius:12px;color:#1f2937;font-size:14px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:10px;font-family:inherit'><svg width='18' height='18' viewBox='0 0 48 48'><path fill='#EA4335' d='M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z'/><path fill='#4285F4' d='M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z'/><path fill='#FBBC05' d='M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z'/><path fill='#34A853' d='M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.18 1.48-4.97 2.31-8.16 2.31-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z'/></svg>Sign in with Google</button><a href='" + b + "login.html' style='display:block;padding:11px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:12px;color:#94a3b8;font-size:13px;font-weight:600;text-decoration:none;margin-bottom:16px'>✉️ Sign in with Email</a><a href='" + b + "index.html' style='font-size:12px;color:#475569;text-decoration:none'>🏠 Home</a></div>";
    } else {
      d.innerHTML = "<div style='max-width:440px;width:100%;background:linear-gradient(135deg,rgba(15,23,42,.99),rgba(20,30,55,.99));border:1.5px solid rgba(245,158,11,.3);border-radius:24px;padding:36px 32px;text-align:center;box-shadow:0 25px 80px rgba(0,0,0,.7)'><div style='font-size:44px;margin-bottom:12px'>⭐</div><h2 style='font-size:22px;font-weight:800;color:#fff;margin-bottom:6px'>Content for students</h2><p style='font-size:13px;color:#94a3b8;margin-bottom:20px'>This material is available only to course students.</p><a href='" + b + "pricing.html' style='display:block;padding:14px;background:linear-gradient(135deg,#f59e0b,#f97316);color:#fff;text-decoration:none;border-radius:14px;font-weight:700;font-size:15px;margin-bottom:10px'>🚀 Get a subscription</a><a href='" + b + "index.html' style='display:block;padding:11px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:12px;color:#94a3b8;font-size:13px;font-weight:600;text-decoration:none'>🏠 Home</a></div>";
    }
