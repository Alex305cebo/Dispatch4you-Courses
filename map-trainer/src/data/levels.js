...
export const LEVELS = [
  ...
  },
  {
    id: 9,
    title: "Зелёная карта",
    subtitle: "Закрась 80% карты правильно",
    icon: "🎯",
    color: "#10b981",
    colorRgb: "16,185,129",
    mode: "green-map",
    ...
    unlockPct: 80,
    xpReward: 800,
    description: "Все 50 штатов. Микс: найди на карте + назови штат. Нет подсказок, нет пропуска. Ошибка = красный навсегда. Цель: 80% зелёных.",
    noHints: true,
    noSkip: true,
  },
  {
    id: 10,
    title: "Speed Run",
    subtitle: "Максимум ответов за 3 минуты",
    icon: "⚡",
    color: "#eab308",
    colorRgb: "234,179,8",
    mode: "speed-run",
    ...
    unlockPct: 0,
    xpReward: 1000,
    description: "Общий таймер 180 секунд. Микс всего. Правильный ответ = +1с, ошибка = −5с. Streak 5+ = +3с. Цель: 40+ правильных.",
    noHints: true,
    noSkip: true,
    isFinal: true,
  },
...
export const RANKS = [
  ...
  { minXp: 3500, title: "Мастер",       icon: "💎", color: "#06b6d4" },
  { minXp: 5000, title: "Легенда",      icon: "👑", color: "#fbbf24" },
];
