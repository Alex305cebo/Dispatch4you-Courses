...
const statsData = [
  {
    ...
    value: '$3.01/mi',
    changeLabel: '+$0.76/милю год к году',
    icon: '🚚',
    color: '#9333ea',
    ...
    facts: [
      { icon: '📈', text: 'Июль 2026 — $3.01/милю, седьмой месяц роста подряд' },
      { icon: '💵', text: 'Год к году +$0.76 на милю: линейхол вырос с $1.63 до $2.39' },
      { icon: '🏆', text: 'Впервые с февраля 2022 спот обогнал контракт — рычаг в переговорах у перевозчика' },
      { icon: '🔮', text: 'DAT iQ прогнозирует ещё +12% по споту в течение 12 месяцев' }
    ],
    source: 'DAT Freight & Analytics — месячные спот-ставки с топливом, январь–июль 2026'
  },
  {
    title: 'Спот-ставка Reefer',
    value: '$3.42/mi',
    changeLabel: '+$0.79/милю год к году',
    icon: '❄️',
    color: '#06b6d4',
    ...
    facts: [
      { icon: '📈', text: 'Июль 2026 — $3.42/милю, рост третий месяц подряд' },
      { icon: '💵', text: 'Год к году +$0.79 на милю по линейхолу' },
  ...
  },
  {
    ...
    value: '$3.64/mi',
    changeLabel: '+$0.86/милю год к году',
    icon: '🪵',
    color: '#10b981',
    ...
    facts: [
      { icon: '📈', text: 'В июне 2026 ставка достигла $3.69/милю — исторический максимум' },
      { icon: '📉', text: 'В июле — небольшой откат до $3.64/милю, единственный из трёх типов' },
  ...
  },
  {
    ...
    facts: [
      ...
      { icon: '📊', text: 'С начала 2026 года — рост на 1.4% к тому же периоду 2025' },
      { icon: '📉', text: 'Июль 2026 — индекс 113.5, минус 0.5% год к году: «уровни тоннажа в последнее время скачут»' },
    ...
    source: 'American Trucking Associations — ATA Truck Tonnage Index, июль 2026'
  },
  {
