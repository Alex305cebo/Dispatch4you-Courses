...
(function () {
  ...
  var narrow = window.matchMedia('(max-width: 768px)');   // выровнено с CSS (моб-блок ≤768): альбомные телефоны 601–768 берут яркие «мобильные» значения, а не тёмные десктопные
