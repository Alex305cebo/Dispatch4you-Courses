...
<div class="nav-links">
  ...
  <div class="nav-item"><button class="nav-btn">Инструменты <span class="arrow">▾</span></button><div class="dropdown"><a href="{{BASE}}pages/ai-broker-chat.html">🎙️ AI – Симулятор переговоров</a><a href="/game/">🎮 Dispatch Office - Симулятор</a><a href="{{BASE}}pages/load-finder.html">📦 Поиск грузов - Load Finder</a><a href="{{BASE}}pages/users-stats.html">🎖️ Рейтинг пользователей</a><a href="{{BASE}}pages/analytics.html">📊 Статистика рынка</a></div></div>
...
<div class="mob-menu" id="mobMenu">
  ...
  <div class="mob-body">
    ...
    <div class="mob-acc" data-section="tools"><div class="mob-acc-title">🛠️ Инструменты <span class="mob-arr">▼</span></div><div class="mob-acc-body"><a href="{{BASE}}pages/ai-broker-chat.html" class="mob-sub">🎙️ AI – Симулятор переговоров</a><a href="/game/" class="mob-sub" style="color:#06b6d4;font-weight:700;">🎮 Dispatch Office - Симулятор</a><a href="{{BASE}}pages/load-finder.html" class="mob-sub">�� Поиск грузов - Load Finder</a><a href="{{BASE}}pages/users-stats.html" class="mob-sub">🎖️ Рейтинг пользователей</a><a href="{{BASE}}pages/analytics.html" class="mob-sub">📊 Статистика рынка</a></div></div>
