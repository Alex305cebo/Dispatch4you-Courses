            ...
            <div class="nav-links">
                ...
                <div class="nav-dropdown has-mega">
                    ...
                    <div class="mega-panel">
                        <div class="mega-col">
                            <div class="mega-col-title">📚 15 Разделов курса</div>
                            <a href="{{BASE}}pages/intro.html" class="mega-item"><span class="mn">01</span>🚛 Введение в индустрию</a>
                            <a href="{{BASE}}pages/glossary.html" class="mega-item"><span class="mn">02</span>📖 Глоссарий терминов</a>
                            <a href="{{BASE}}pages/role.html" class="mega-item"><span class="mn">03</span>👔 Роль диспетчера</a>
                            <a href="{{BASE}}pages/equipment.html" class="mega-item"><span class="mn">04</span>🚚 Оборудование и грузы</a>
                            <a href="{{BASE}}pages/routes.html" class="mega-item"><span class="mn">05</span>🗺️ География и маршруты</a>
                            ...
                            <a href="{{BASE}}pages/brokers.html" class="mega-item"><span class="mn">08</span>🛡️ Проверка брокеров</a>
                            ...
                            <a href="{{BASE}}pages/finances.html" class="mega-item"><span class="mn">14</span>💰 Финансы и расчёты</a>
                            <a href="{{BASE}}pages/career.html" class="mega-item"><span class="mn">15</span>💼 Карьера и практики</a>
                        </div>
                        <div class="mega-col">
                            <div class="mega-col-title">🎓 12 Модулей с тестами</div>
                            ...
                            <div class="mega-col-title" style="margin-top:12px">📁 Ресурсы</div>
