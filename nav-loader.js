...
<div class="nav-links">
  ...
  <a href="{{BASE}}pages/users-stats.html" class="nav-btn" style="text-decoration:none;color:#94a3b8;">📊 Стат</a>
</div>
...
<div class="mob-menu" id="mobMenu">
  ...
  <div class="mob-body">
    ...
    <div class="mob-acc"><div class="mob-acc-title">🛠️ Инструменты <span class="mob-arr">▼</span></div><div class="mob-acc-body"><a href="{{BASE}}pages/simulator.html" class="mob-sub">🎯 Симулятор</a><a href="{{BASE}}pages/testing.html" class="mob-sub">✍️ Тестирование</a><a href="{{BASE}}pages/Trainer-Quiz.html" class="mob-sub">⚡ Тренировка</a><a href="{{BASE}}pages/load-finder.html" class="mob-sub">🔍 Load Finder</a><a href="{{BASE}}pages/ai-broker-chat.html" class="mob-sub">🤖 AI Брокер</a><a href="{{BASE}}pages/users-stats.html" class="mob-sub">📊 Статистика</a></div></div>
