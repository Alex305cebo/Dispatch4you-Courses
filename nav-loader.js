...
(function () {
    ...
    function loadNav() {
        ...
        var navFile = (LANG === 'ru' ? '/nav.html' : '/nav.' + LANG + '.html') + '?v=14.0';
        fetch(navFile)
...
<div class="nav-links">
  ...
  <a href="{{BASE}}pricing.html" class="nav-btn nav-btn-link">💎 Цены</a>
  <div class="nav-item"><button class="nav-btn" aria-haspopup="true" aria-expanded="false">О сервисе <span class="arrow">▾</span></button><div class="dropdown"><a href="{{BASE}}about.html">ℹ️ О нас</a><a href="{{BASE}}faq.html">❓ Частые вопросы</a><a href="{{BASE}}contacts.html">📩 Написать нам</a><a href="{{BASE}}career.html">🚀 Работа у нас</a></div></div>
