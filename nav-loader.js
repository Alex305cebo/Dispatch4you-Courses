...
<div class="nav-links">
  ...
  <div class="nav-item"><button class="nav-btn">Информация <span class="arrow">▾</span></button><div class="dropdown"><a href="{{BASE}}about.html">�� О курсе</a><a href="{{BASE}}faq.html">❓ Частые вопросы</a><a href="{{BASE}}contacts.html">📩 Написать нам</a><a href="{{BASE}}pricing.html">💎 Планы и цены</a></div></div>
