...
<div class="nav-links">
  ...
  <div class="nav-item"><button class="nav-btn">Инструменты <span class="arrow">▾</span></button><div class="dropdown"><a href="/game/">🎮 Dispatch Office - Симулятор</a><a href="/map-trainer/">🗺️ USA Map Trainer</a><a href="{{BASE}}pages/ai-broker-chat.html">🎙️ AI – Симулятор переговоров</a><a href="{{BASE}}pages/load-finder.html">📦 Поиск грузов - Load Finder</a><a href="{{BASE}}pages/users-stats.html">🎖️ Рейтинг пользователей</a><a href="{{BASE}}pages/analytics.html">📊 Статистика рынка</a></div></div>
...
<div class="mob-menu" id="mobMenu">
  ...
  <div class="mob-body">
    ...
    <div class="mob-acc" data-section="tools"><div class="mob-acc-title">🛠️ Инструменты <span class="mob-arr">▼</span></div><div class="mob-acc-body"><a href="/game/" class="mob-sub" style="color:#06b6d4;font-weight:700;">🎮 Dispatch Office - Симулятор</a><a href="/map-trainer/" class="mob-sub" style="color:#06b6d4;font-weight:700;">🗺️ USA Map Trainer</a><a href="{{BASE}}pages/ai-broker-chat.html" class="mob-sub">🎙️ AI – Симулятор переговоров</a><a href="{{BASE}}pages/load-finder.html" class="mob-sub">�� Поиск грузов - Load Finder</a><a href="{{BASE}}pages/users-stats.html" class="mob-sub">🎖️ Рейтинг пользователей</a><a href="{{BASE}}pages/analytics.html" class="mob-sub">📊 Статистика рынка</a></div></div>
      ...
      <div class="footer-grid">
        ...
        <div class="footer-acc-col">
          ...
          <div class="footer-acc-body">
            ...
            <a href="BASE_pages/glossary.html" class="footer-link">📖 Термины и Сокращения</a>
            <a href="BASE_pages/testing.html" class="footer-link">🎯 Тестирование диспетчера</a>
            <a href="BASE_pages/Trainer-Quiz.html" class="footer-link">💡 Тренажер диспетчера</a>
          </div>
        </div>
        <div class="footer-acc-col">
          ...
          <div class="footer-acc-body">
            ...
            <a href="/map-trainer/" class="footer-link">🗺️ USA Map Trainer</a>
            <a href="BASE_pages/ai-broker-chat.html" class="footer-link">🎙️ AI – Симулятор переговоров</a>
            <a href="BASE_pages/load-finder.html" class="footer-link">📦 Поиск грузов - Load Finder</a>
        ...
        <div class="footer-acc-col">
          ...
          <div class="footer-acc-body">
            ...
            <a href="BASE_career.html" class="footer-link">❓ Частые вопросы</a>
