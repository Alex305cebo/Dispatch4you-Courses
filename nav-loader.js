...
<div class="nav-links">
  ...
  <div class="nav-item"><button class="nav-btn">Инструменты <span class="arrow">▾</span></button><div class="dropdown"><a href="{{BASE}}pages/ai-broker-chat.html">🎙️ AI – симулятор переговоров</a><a href="/game/">🎮 Dispatch Office - Симулятор</a><a href="{{BASE}}pages/load-finder.html">📦 Load Finder</a><a href="{{BASE}}pages/users-stats.html">🎖️ Рейтинг пользователей</a><a href="{{BASE}}pages/analytics.html">📊 Статистика рынка</a></div></div>
  <div class="nav-item"><button class="nav-btn">Информация <span class="arrow">▾</span></button><div class="dropdown"><a href="{{BASE}}about.html">ℹ️ О нас</a><a href="{{BASE}}pricing.html">💎 Тарифы</a><a href="{{BASE}}career.html">🚀 Карьера</a><a href="{{BASE}}faq.html">❓ FAQ</a><a href="{{BASE}}contacts.html">📩 Контакты</a></div></div>
...
<div class="mob-menu" id="mobMenu">
  ...
  <div class="mob-body">
    ...
    <div class="mob-acc"><div class="mob-acc-title">🛠️ Инструменты <span class="mob-arr">▼</span></div><div class="mob-acc-body"><a href="{{BASE}}pages/ai-broker-chat.html" class="mob-sub">🎙️ AI – симулятор переговоров</a><a href="/game/" class="mob-sub" style="color:#06b6d4;font-weight:700;">🎮 Dispatch Office - Симулятор</a><a href="{{BASE}}pages/load-finder.html" class="mob-sub">📦 Load Finder</a><a href="{{BASE}}pages/users-stats.html" class="mob-sub">🎖️ Рейтинг пользователей</a><a href="{{BASE}}pages/analytics.html" class="mob-sub">📊 Статистика рынка</a></div></div>
    <div class="mob-acc"><div class="mob-acc-title">ℹ️ Информация <span class="mob-arr">▼</span></div><div class="mob-acc-body"><a href="{{BASE}}about.html" class="mob-sub">ℹ️ О нас</a><a href="{{BASE}}pricing.html" class="mob-sub">💎 Тарифы</a><a href="{{BASE}}career.html" class="mob-sub">🚀 Карьера</a><a href="{{BASE}}faq.html" class="mob-sub">❓ FAQ</a><a href="{{BASE}}contacts.html" class="mob-sub">📩 Контакты</a></div></div>
  </div>
</div>`;
    ...
    <div class="footer-inner">
      <div class="footer-grid">
        ...
        <div class="footer-acc-col">
          ...
          <div class="footer-acc-body">
            <a href="BASE_pages/ai-broker-chat.html" class="footer-link">🎙️ AI – симулятор переговоров</a>
            <a href="/game/" class="footer-link">🎮 Dispatch Office - Симулятор</a>
            <a href="BASE_pages/load-finder.html" class="footer-link">📦 Load Finder</a>
            <a href="BASE_pages/users-stats.html" class="footer-link">🎖️ Рейтинг пользователей</a>
