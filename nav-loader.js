...
(function () {
    ...
    var EN_PAGES = ['/', '/about.html', '/career.html', '/checkout.html', '/contacts.html', '/dashboard.html', '/documentation.html', '/faq.html', '/index.html', '/login.html', '/pages/Trainer-Quiz.html', '/pages/admin.html', '/pages/ai-broker-chat.html', '/pages/all-loads.html', '/pages/amazon-relay.html', '/pages/amazon-relay-2-loads.html', '/pages/amazon-relay-3-problems.html', '/pages/amazon-relay-4-money-rating.html', '/pages/amazon-relay-video.html', '/pages/amazon-relay-video-2.html', '/pages/amazon-relay-video-3.html', '/pages/amazon-relay-video-4.html', '/pages/analytics.html', '/pages/brokers.html', '/pages/career.html', '/pages/cases.html', '/pages/communication.html', '/pages/doc-module-1-complete.html', '/pages/doc-module-10-complete.html', '/pages/doc-module-11-complete.html', '/pages/doc-module-12-complete.html', '/pages/doc-module-2-complete.html', '/pages/doc-module-3-complete.html', '/pages/doc-module-4-complete.html', '/pages/doc-module-5-complete.html', '/pages/doc-module-6-complete.html', '/pages/doc-module-7-complete.html', '/pages/doc-module-8-complete.html', '/pages/doc-module-9-complete.html', '/pages/docs.html', '/pages/documentation.html', '/pages/equipment.html', '/pages/finances.html', '/pages/games.html', '/pages/glossary.html', '/pages/intro.html', '/pages/lesson-tracker.html', '/pages/load-finder.html', '/pages/loadboards.html', '/pages/messages.html', '/pages/modules-index.html', '/pages/negotiation.html', '/pages/problems.html', '/pages/regulations.html', '/pages/role.html', '/pages/routes.html', '/pages/technology.html', '/pages/testing.html', '/pages/users-stats.html', '/pricing.html', '/register.html'];
    ...
    function loadNav() {
        ...
        var navFile = (LANG === 'ru' ? '/nav.html' : '/nav.' + LANG + '.html') + '?v=14.6';
        fetch(navFile)
...
<a href="BASE_pages/cases.html" class="footer-link">${T.lCases}</a>
        ...
        <div class="footer-acc-col">
          ...
          <div class="footer-acc-body">
            ...
            <a href="/games/dispatch-academy-app/" class="footer-link">${T.lCareerPath}</a>
          </div>
        </div>
        <div class="footer-acc-col">
    ...
    // видит только администратор. Роль берём тем же currentRole(), что и
    // остальные пункты меню: он сперва спрашивает RoleGuard и только потом
    // читает localStorage, то есть знает актуальное значение раньше.
    // Подделать роль в консоли можно, и это нормально: тут прячется
    // незаконченное оформление, а не данные.
    function themeSwitchAllowed() {
        return String(currentRole()).toLowerCase() === 'superuser';
    }
