...
(function () {
    ...
    var STR = {
        ru: {
            ...
            lGame: '🎮 Dispatch Office - Симулятор', lMap: '🗺️ USA Map Trainer', lAiChat: '🎙️ AI – Симулятор переговоров',
        ...
        en: {
            ...
            lGame: '🎮 Dispatch Office — Simulator', lMap: '🗺️ USA Map Trainer', lAiChat: '🎙️ AI — Negotiation Simulator',
    ...
    function loadNav() {
        ...
        var navFile = (LANG === 'ru' ? '/nav.html' : '/nav.' + LANG + '.html') + '?v=11.0';
        fetch(navFile)
    ...
    <div class="footer-inner">
      <div class="footer-grid">
        ...
        <div class="footer-acc-col">
          ...
          <div class="footer-acc-body">
            <a href="/game/" class="footer-link">${T.lGame}</a>
