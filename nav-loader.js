            ...
            <div class="nav-links">
                ...
                <div class="nav-dropdown has-mega">
                    ...
                    <div class="mega-panel">
                        <div class="mega-acc open">
                            <div class="mega-acc-head">📚 15 Разделов курса <span class="mega-arr">▼</span></div>
                            <div class="mega-acc-body">
                                <div class="mega-grid">
                        ...
                        <div class="mega-acc">
                            <div class="mega-acc-head">🎓 12 Модулей с тестами <span class="mega-arr">▼</span></div>
                            <div class="mega-acc-body">
                                <div class="mega-grid">
                        ...
                        <div class="mega-acc">
                            <div class="mega-acc-head">📁 Ресурсы <span class="mega-arr">▼</span></div>
                            <div class="mega-acc-body">
                                <div class="mega-grid mega-grid-res">
