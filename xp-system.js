...
export const XP_ACTIONS = {
    ...
    BROKER_SESSION_COMPLETE: { xp: 50, label: '📞 Диалог с брокером завершён', key: 'brokerSessionComplete' },
    BROKER_HIGH_SCORE: { xp: 25, label: '⭐ Высокий балл (8+)', key: 'brokerHighScore' },
    BROKER_PERFECT_SCORE: { xp: 50, label: '🏆 Отличный балл (9+)', key: 'brokerPerfectScore' },
};
