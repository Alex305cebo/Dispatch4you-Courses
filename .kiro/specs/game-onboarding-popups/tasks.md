...
- [x] 5. Интеграция в game.tsx и добавление data-onboarding атрибутов
  - [x] 5.1 Добавить `data-onboarding` атрибуты в существующие компоненты
  ...
  - [x] 5.2 Интегрировать онбординг в `adventure/app/game.tsx`
  ...
  - [x] 5.3 Сохранить существующие GuideSpotlight и GuideBubble
...
- [x] 6. Адаптивность и финальная полировка
  - [x] 6.1 Обеспечить адаптивность для мобильных устройств
...
- [x] 7. Финальный checkpoint — Убедиться что всё работает
  - Убедиться что все тесты проходят, задать вопросы пользователю если возникнут.
