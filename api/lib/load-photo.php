...
function rcPrompt() {
  ...
  . "- DECIDING WHERE A NUMBER GOES: if it is printed inside a pickup's or a delivery's own section or "
  . "row — PU#, PO#, appointment or confirmation number, warehouse reference — it goes into THAT stop's "
  . "refs and nowhere else, even when the label looks generic. Top-level refs are only for numbers "
  . "printed once for the whole shipment, outside every stop section. Putting a stop's number in the "
  . "wrong place sends the driver to the gate quoting a number that belongs to the other end of the trip.\n"
