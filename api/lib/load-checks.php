<?php
// Проверки поверх уже разобранного груза: не мошенничество ли это и успевает ли
// водитель по часам. Ни одна функция тут никуда не ходит и ничего не печатает —
