...
const scenario_tom = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 Standard opening question — MC and company",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Truck location and readiness for pickup",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Temperature spec and driver experience with delicate cargo",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Cargo insurance — minimum $150K",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 NEGOTIATE! Posted $11,800 — ask for $13,200-14,000",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Broker offers $12,800 — negotiate",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Deal! Give your email for the rate confirmation",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES:\n• Rate: $13,000\n• Posted: $11,800\n• Above posted by: +$1,200 (+10.2%)\n• Fuel: ~$1,244\n• Net profit: ~$11,756\n\n🎯 WHAT WORKED:\n✅ Clear MC and company on the first try\n✅ Demonstrated produce experience\n✅ Didn't accept the first offer of $12,800\n✅ Negotiated with real arguments (6 years on the lane)\n✅ Closed the deal professionally\n\n💡 LESSON: "That's my ceiling" isn't always true. A confident counter backed by value earned an extra +$200.`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "Hey, I need your MC number and company name. Can you give me that clearly?", dispatcherPrompt: "💡 Broker asks again for MC and company", suggestions: [
            ...
            {
                brokerResponse: "Where exactly is your reefer? I need to know it can make 6 AM.", dispatcherPrompt: "💡 Broker wants an exact location", suggestions: [
            ...
            {
                brokerResponse: "I need to know your driver has produce experience. Fresh berries bruise.", dispatcherPrompt: "💡 Broker insists on produce experience", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "Look, I need MC and company name before we go any further.", dispatcherPrompt: "⚠️ Last chance", suggestions: [
        ...
        reject_weak_final: [{ brokerResponse: "I'm going to pass. Need a carrier who's more prepared. Good luck.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unprepared dispatcher.\n\n💡 Always know your MC, truck location, and company details cold." } }],
        reject_attitude_final: [{ brokerResponse: "Not going to work with that attitude. Moving on.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude.\n\n💡 Even if the questions feel unnecessary — answer professionally." } }],
        reject_timing_final: [{ brokerResponse: "Can't use you if you can't make the pickup window. Thanks anyway.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you can't make the pickup on time.\n\n💡 Never take a load if you're not sure about the timing." } }],
        reject_rate_final: [{ brokerResponse: "That rate doesn't work. I'll find someone else.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unrealistic rate.\n\n💡 Negotiate within reason — $1-2/mile above posted." } }],
        reject_email_final: [{ brokerResponse: "I need an email to send the rate con. Can't book without it.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: no email.\n\n💡 Always have a working dispatch email ready." } }]
    }
};
...
const scenario_dave = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 The broker is pushing on urgency — answer clearly and fast",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Steel coil experience — blocking, bracing, safety",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Pickup today at 3 PM — confirm realistically",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 The broker is pushing — don't accept posted right away! Negotiate",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Broker accepted $3,500 — confirm the timing and insurance",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Final details — confirm everything clearly",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES:\n• Rate: $3,500\n• Posted: $3,200\n• Above posted by: +$300 (+9.4%)\n• Fuel: ~$436 (1,090 mi)\n• Net profit: ~$3,064\n\n🎯 WHAT WORKED:\n✅ Answered fast under pressure\n✅ Didn't accept posted $3,200 right away\n✅ Made the case: same-day + steel specialist\n✅ Confirmed timing realistically\n✅ Had insurance ready\n\n💡 LESSON: "I've got three other carriers" — a classic bluff. A confident dispatcher doesn't panic and negotiates.`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "I need your MC and company name — fast.", dispatcherPrompt: "💡 Broker asks again", suggestions: [
            ...
            {
                brokerResponse: "Does your driver actually have steel coil experience or not?", dispatcherPrompt: "💡 Broker insists on coil experience", suggestions: [
            ...
            {
                brokerResponse: "Can your driver actually make 3 PM or not? I need a straight answer.", dispatcherPrompt: "💡 Broker wants a clear answer on timing", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "MC and company name. Now.", dispatcherPrompt: "⚠️ Last chance", suggestions: [
                { text: "MC 556688, Iron Road Carriers.", quality: "good", path: "master" },
                { text: "MC 556688.", quality: "normal", path: "master" },
        ...
        reject_weak_final: [{ brokerResponse: "I don't have time for this. Moving on.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unprepared dispatcher.\n\n💡 Under pressure you need to answer fast and clear. Know your MC cold." } }],
        reject_attitude_final: [{ brokerResponse: "Not dealing with this attitude. Next carrier.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude.\n\n💡 An urgent broker pushes — that's normal. Stay professional." } }],
        reject_timing_final: [{ brokerResponse: "Can't wait. Found another carrier. Thanks.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you can't make the pickup on time.\n\n💡 Never take on a load if you're not sure about the timing." } }],
        reject_rate_final: [{ brokerResponse: "That rate is way off. I'll find someone else.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unrealistic rate.\n\n💡 On urgent loads you can ask 10-20% above posted, not 50%." } }],
        reject_email_final: [{ brokerResponse: "I need certs before I send the rate con. That's non-negotiable.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: no insurance.\n\n💡 Always have your insurance certificates ready to send." } }]
    }
};
...
const scenario_kevin = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 The broker wants to know about your company — tell them confidently",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Cargo security — $800K electronics, cargo theft on the LA-Dallas lane",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Insurance — minimum $250K for an $800K load",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 The broker wants to know the driver — that's normal for high-value freight",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 NEGOTIATE! Posted $4,100 — ask for $4,600-5,000",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Broker offers $4,500 + regular loads — a great opportunity!",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Final details — confirm everything",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES:\n• Rate: $4,500\n• Posted: $4,100\n• Above posted by: +$400 (+9.8%)\n• Fuel: ~$572 (1,430 mi)\n• Net profit: ~$3,928\n\n🎯 WHAT WORKED:\n✅ Talked about your company with confidence\n✅ Knew the security protocols for electronics\n✅ Offered the driver's name and history\n✅ Negotiated and got +$400\n✅ Accepted the offer for regular loads\n\n💡 LESSON: A friendly broker doesn't mean an easy one. Kevin vetted every detail. And now you've got 3-4 loads a week!`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "Tell me more about your company — how long, how many trucks?", dispatcherPrompt: "💡 The broker wants company details", suggestions: [
            ...
            {
                brokerResponse: "What security measures do you have for high-value electronics?", dispatcherPrompt: "💡 Broker insists on security", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "I need to know about your company before we go further.", dispatcherPrompt: "⚠️ Last chance", suggestions: [
        ...
        reject_weak_final: [{ brokerResponse: "I need a carrier who knows their business. Good luck.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you don't know your own company.\n\n💡 Know your company details cold: MC, years in business, number of trucks, specialization." } }],
        reject_attitude_final: [{ brokerResponse: "Not the right fit. Moving on.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude.\n\n💡 A friendly broker expects a friendly response. Build the relationship." } }],
        reject_rate_final: [{ brokerResponse: "That rate is unrealistic for this lane. Thanks anyway.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unrealistic rate.\n\n💡 On electronics you can ask 10-15% above posted, not 50%." } }],
        reject_email_final: [{ brokerResponse: "I need certs before booking. That's standard for high-value freight.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: no insurance.\n\n💡 For high-value freight, insurance certificates are required immediately." } }]
    }
};
...
const scenario_mark = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 MC + a technical question about permits for 14ft cargo",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Truck type and driver experience with oversize/machinery",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Technical question — number of straps and chains for 38,000 lbs",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Insurance $500K for a $1.2M machine",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 NEGOTIATE! Posted $5,800 — ask for $6,500-7,000",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 $6,400 accepted — confirm permits pulled before Wednesday",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES:\n• Rate: $6,400\n• Posted: $5,800\n• Above posted by: +$600 (+10.3%)\n• Fuel: ~$560 (1,400 mi)\n• Net profit: ~$5,840\n\n🎯 WHAT WORKED:\n✅ Knew about permits for 14ft cargo\n✅ Gave specific details: chains, straps\n✅ Had $750K insurance for a $1.2M machine\n✅ Negotiated confidently with real arguments\n✅ Confirmed the permit timeline realistically\n\n💡 LESSON: A technical broker tests your knowledge. Specific answers (8 chains, 14ft permit) = trust = a better rate.`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "Do you know if 14ft cargo needs a permit in Georgia?", dispatcherPrompt: "💡 Broker asks again about permits", suggestions: [
            ...
            {
                brokerResponse: "How many chains for 38,000 lbs machinery?", dispatcherPrompt: "💡 Technical question about securement", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "MC and company — and do you actually know oversize freight?", dispatcherPrompt: "⚠️ Last chance", suggestions: [
        ...
        reject_weak_final: [{ brokerResponse: "I need someone who knows oversize freight. Thanks.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you don't know the technical details.\n\n💡 For oversize/machinery you need to know: permits, chains, load plans." } }],
        reject_attitude_final: [{ brokerResponse: "Not the right carrier. Moving on.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude.\n\n💡 A technical broker values knowledge and professionalism." } }],
        reject_timing_final: [{ brokerResponse: "Can't use you if permits aren't ready in time.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: permits not ready in time.\n\n💡 Permits are your responsibility. Know the timelines." } }],
        reject_rate_final: [{ brokerResponse: "That rate is way off market. Thanks anyway.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unrealistic rate.\n\n💡 On machinery, 10-20% above posted is reasonable. 50%+ is not." } }]
    }
};
...
const scenario_chris = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 MC + GDP knowledge — Good Distribution Practice for pharma",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 GDP training certificate for the driver",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 $300K insurance + claims history for pharma",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 NEGOTIATE! Posted $6,200 — ask for $7,000-7,500",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 $6,800 accepted — send all documents immediately",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES:\n• Rate: $6,800\n• Posted: $6,200\n• Above posted by: +$600 (+9.7%)\n• Fuel: ~$620 (1,550 mi)\n• Net profit: ~$6,180\n\n🎯 WHAT WORKED:\n✅ Knew what GDP means\n✅ Named a specific data logger (Sensitech)\n✅ Driver with a GDP certificate\n✅ Pharma-specific insurance\n✅ Ready to send all documents immediately\n\n💡 LESSON: Pharma brokers don't negotiate on documentation. Knowing GDP and being ready for compliance = trust = a better rate.`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "What exactly is GDP? I need to know you understand this.", dispatcherPrompt: "💡 The broker is testing your GDP knowledge", suggestions: [
            ...
            {
                brokerResponse: "Do you have a calibrated data logger?", dispatcherPrompt: "💡 Broker insists on a data logger", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "Do you actually have pharma experience or not?", dispatcherPrompt: "⚠️ Last chance", suggestions: [
        ...
        reject_weak_final: [{ brokerResponse: "I can't risk pharma freight with a carrier who doesn't know GDP. Thanks.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you don't know the pharma requirements.\n\n💡 GDP, data loggers, certified drivers — mandatory knowledge for pharma freight." } }],
        reject_attitude_final: [{ brokerResponse: "Pharma freight is not for everyone. Moving on.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude toward compliance.\n\n💡 Pharma brokers are the strictest. Compliance is not optional." } }],
        reject_rate_final: [{ brokerResponse: "That rate is unrealistic. Thanks anyway.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unrealistic rate.\n\n💡 Pharma pays well, but not double the market." } }],
        reject_email_final: [{ brokerResponse: "I need all docs before rate con. That's non-negotiable for pharma.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: no documents.\n\n💡 For pharma, all documents must be ready immediately." } }]
    }
};
...
const scenario_steve = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 The broker remembers you — confirm and strengthen the relationship",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Standard load — confirm you have a truck in Phoenix",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 The broker is offering volume — don't sell yourself too cheap!",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 $4,000 x 6 loads = $24K/week — a good deal, but negotiate",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Deal! Email for the rate con + start of a long-term relationship",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES (single load):\n• Rate: $4,000\n• Posted: $4,400\n• Below posted by: -$400 (but...)\n• Fuel: ~$700 (1,750 mi)\n• Net profit: ~$3,300\n\n📈 THE REAL PICTURE:\n• 6 loads/week × $4,000 = $24,000/week\n• $24,000 × 52 weeks = $1,248,000/year\n• Stability beats $400 on a single load!\n\n🎯 WHAT WORKED:\n✅ Didn't sell out at $3,800 — held at $4,000\n✅ Insisted on a written agreement\n✅ Understood the value of a long-term relationship\n✅ Closed the deal professionally\n\n💡 LESSON: Volume = stability. A small discount for a guaranteed 6 loads/week is smart business.`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "Can you confirm your MC and company name?", dispatcherPrompt: "💡 Broker asks again", suggestions: [
            ...
            {
                brokerResponse: "Is your driver actually available Monday 9 AM in Phoenix?", dispatcherPrompt: "💡 The broker wants confirmation", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "I need to confirm your MC before we go further.", dispatcherPrompt: "⚠️ Last chance", suggestions: [
                { text: "MC 778899, FastLane Logistics.", quality: "good", path: "master" },
                { text: "MC 778899.", quality: "normal", path: "master" },
        ...
        reject_weak_final: [{ brokerResponse: "I need a carrier who's prepared. Thanks.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unprepared dispatcher.\n\n💡 Even with a repeat broker — know your details cold." } }],
        reject_attitude_final: [{ brokerResponse: "Not the right attitude for a long-term partner. Moving on.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude.\n\n💡 A repeat broker is a partner. Treat them accordingly." } }],
        reject_timing_final: [{ brokerResponse: "Can't use you if you can't confirm the pickup. Thanks.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you can't confirm the timing.\n\n💡 Always know where your truck is and when it's free." } }],
        reject_rate_final: [{ brokerResponse: "Volume discount is standard in this business. If you can't work with that, I'll find someone who can.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: couldn't agree on a rate.\n\n💡 Volume = discount. That's normal. The key is not going below your cost." } }],
        reject_email_final: [{ brokerResponse: "I need email for the rate con and carrier agreement. Can't proceed without it.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: no email.\n\n💡 Email is the backbone of your paperwork. Always have a working address." } }]
    }
};
...
const scenario_brian = {
    ...
    paths: {
        master: [
            {
                ...
                dispatcherPrompt: "💡 The aggressive broker is pushing — answer fast and confidently",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 The broker immediately pushes posted — DON'T accept! Negotiate confidently",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Broker accepted $2,300 but added conditions — assess them realistically",
                suggestions: [
            ...
            },
            {
                ...
                dispatcherPrompt: "💡 Insurance is needed right away — have it ready",
                suggestions: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    rate: "$2,300",
                    ratePerMile: "$3.15/mile",
                    feedback: `✅ GREAT JOB!\n\n💰 FINANCES:\n• Rate: $2,300\n• Posted: $2,100\n• Above posted by: +$200 (+9.5%)\n• Fuel: ~$292 (730 mi)\n• Net profit: ~$2,008\n\n🎯 WHAT WORKED:\n✅ Didn't flinch at the aggression — answered fast\n✅ Didn't accept posted $2,100\n✅ Stood your ground on the detention policy\n✅ Had insurance ready immediately\n✅ Closed the deal cleanly\n\n💡 LESSON: "I've got 10 carriers" — a classic bluff. An aggressive broker respects confidence. Panic and concessions are weakness.`
                }
            }
        ],
        warning: [
            {
                brokerResponse: "MC and company — I don't have all day.", dispatcherPrompt: "💡 Broker asks again", suggestions: [
            ...
            {
                brokerResponse: "Can you make 6:30 AM or not? Straight answer.", dispatcherPrompt: "💡 The broker wants a clear answer", suggestions: [
        ...
        warning_strict: [{
            brokerResponse: "MC. Now.", dispatcherPrompt: "⚠️ Last chance", suggestions: [
                { text: "MC 445566, Midwest Auto Carriers.", quality: "good", path: "master" },
                { text: "MC 445566.", quality: "normal", path: "master" },
        ...
        reject_weak_final: [{ brokerResponse: "Moving on. Next carrier.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unprepared dispatcher.\n\n💡 An aggressive broker won't wait. Know your MC cold, answer instantly." } }],
        reject_attitude_final: [{ brokerResponse: "Don't need that attitude. Next.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: bad attitude.\n\n💡 Aggression met with aggression is a loss. Stay professional." } }],
        reject_timing_final: [{ brokerResponse: "Can't use you. Need someone who can make the window.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: you can't make the pickup on time.\n\n💡 Never take on a load if you're not sure about the timing." } }],
        reject_rate_final: [{ brokerResponse: "Way off market. Next carrier.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: unrealistic rate.\n\n💡 On short runs (730 mi) you can't ask for double the posted rate." } }],
        reject_email_final: [{ brokerResponse: "I need certs before rate con. That's how it works.", outcome: { type: "failure", quality: "fail", rate: "$0", feedback: "❌ Broker passed: no insurance.\n\n💡 Insurance certificates must be ready to send at any moment." } }]
    }
};
