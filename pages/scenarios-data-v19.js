// DIALOGUE #19 - Dry Van Furniture (ПРАВИЛЬНЫЙ ФОРМАТ!)
// Miami FL → New York NY, 1,280 miles
// Posted: $2,600 ($2.03/mile), Target: $2,900-3,100
// Created: March 8, 2026

console.log('🔵 Loading scenarios-data-v19.js...');
...
const scenario19 = {
    ...
    paths: {
        master: [
            {
                ...
                suggestions: [
                    ...
                    { text: "MC 445566... we have some vans...", quality: "weak", analytics: "⚠️ Неуверенный ответ, нет конкретики!", path: "weak" },
                    { text: "Why all these questions? Tell me the rate!", quality: "aggressive", analytics: "🔴 Грубость! Отказ отвечать на вопросы!", path: "warning" },
                    { text: "Dry van available. What's the load?", quality: "fail", analytics: "❌ Не дал MC number - критическая ошибка!", path: "warning" }
                ]
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should be in Miami... has equipment...", quality: "weak", analytics: "⚠️ Неуверенность в местоположении и equipment!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Driver has some furniture experience... DOT should be okay...", quality: "weak", analytics: "⚠️ Неуверенность в опыте и DOT!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have $100K... liability is good...", quality: "weak", analytics: "⚠️ Неуверенность в страховке!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "We'll send updates... will call if problems...", quality: "weak", analytics: "⚠️ Расплывчато, нет конкретных обязательств!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "We'll try for Wednesday 2 PM... should be okay...", quality: "weak", analytics: "⚠️ 'Try' вместо commitment - красный флаг!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have equipment... driver will check...", quality: "weak", analytics: "⚠️ Неуверенность в наличии equipment!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "I think I can find some references...", quality: "weak", analytics: "⚠️ Неуверенность, нет готовых references!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Standard detention... payment terms flexible...", quality: "weak", analytics: "⚠️ Расплывчато, нет конкретных цифр!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "FSC should be included... can give contacts...", quality: "weak", analytics: "⚠️ Неуверенность в FSC и contacts!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have backup... claims are minimal...", quality: "weak", analytics: "⚠️ Неуверенность в backup и claims!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "$2,700 for this load?", quality: "weak", analytics: "⚠️ Только $100 выше posted, слабый торг!", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Okay, $2,800 will work...", quality: "weak", analytics: "⚠️ Неуверенное принятие.", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Okay, $2,850...", quality: "weak", analytics: "⚠️ Неуверенное принятие final.", path: "weak" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Let me find email... will handle requirements...", quality: "weak", analytics: "⚠️ Не знает email сразу!", path: "weak" },
        ...
        weak: [
            {
                brokerQuestion: "You said 'some vans'? I need exact numbers - how many dry vans and where is one for this load?",
                dispatcherPrompt: "⚠️ Брокер требует точности! Сколько vans и где находится?",
                suggestions: [
                    { text: "I apologize for being unclear. We have 30 dry vans. The one for this load is in Miami at furniture warehouse, empty and ready. Has lift gate and air-ride. Driver ready for 9 AM pickup.", quality: "good", analytics: "✔️ ИСПРАВИЛСЯ! Дал точные цифры (30 vans), местоположение, equipment, готовность.", path: "master" },
                    { text: "We have 30 vans. One is in Miami, ready.", quality: "normal", analytics: "⚪ Дал цифры и местоположение, но без деталей.", path: "weak" },
                    { text: "We have several vans... one should be available...", quality: "weak", analytics: "⚠️ СНОВА неуверенность, нет конкретики!", path: "weak" },
                    { text: "I need to check with dispatch...", quality: "fail", analytics: "❌ Не знает свой fleet!", path: "reject_weak_final" },
                    { text: "Why so many questions? Just give me the load!", quality: "aggressive", analytics: "🔴 Грубость вместо ответа!", path: "reject_weak_final" },
                    { text: "I don't know exactly... maybe 25 vans?", quality: "fail", analytics: "❌ Не знает свою компанию!", path: "reject_weak_final" }
                ]
            },
            {
                brokerQuestion: "Okay. Driver furniture experience? Van has lift gate and air-ride?",
                dispatcherPrompt: "💎 Брокер проверяет опыт водителя и equipment van!",
                suggestions: [
                    { text: "Yes! Driver has 4 years furniture experience, understands careful handling. Van has lift gate and air-ride suspension - both critical for furniture. Service report available.", quality: "good", analytics: "✔️ ХОРОШО! Опыт 4 года, понимание handling, оба equipment, report.", path: "master" },
                    { text: "Driver has furniture experience. Van has lift gate and air-ride.", quality: "normal", analytics: "⚪ Опыт есть, equipment есть, без деталей.", path: "weak" },
                    { text: "Driver has some experience... van should have equipment...", quality: "weak", analytics: "⚠️ СЛАБО! Неуверенность в опыте и equipment!", path: "weak" },
                    { text: "Driver can handle any load.", quality: "aggressive", analytics: "🔴 Нет конкретики по furniture!", path: "reject_weak_final" },
                    { text: "Not sure about lift gate...", quality: "fail", analytics: "❌ Не знает equipment!", path: "reject_weak_final" },
                    { text: "Driver is new but learns fast.", quality: "fail", analytics: "❌ Нет опыта!", path: "reject_weak_final" }
                ]
            },
            {
                brokerQuestion: "$100K cargo insurance? Tracking policy?",
                dispatcherPrompt: "💎 Брокер проверяет insurance и tracking!",
                suggestions: [
                    { text: "Yes! $100K cargo insurance through Progressive. GPS tracking with updates every 6 hours. I'll send insurance cert after booking.", quality: "good", analytics: "✔️ ХОРОШО! Insurance детали, tracking с частотой.", path: "master" },
                    { text: "$100K insurance. Have GPS tracking.", quality: "normal", analytics: "⚪ Insurance и tracking есть, без деталей.", path: "weak" },
                    { text: "Should have insurance... tracking available...", quality: "weak", analytics: "⚠️ СЛАБО! Неуверенность!", path: "weak" },
                    { text: "Insurance is standard. Don't worry.", quality: "aggressive", analytics: "🔴 Отказ давать детали!", path: "reject_weak_final" },
                    { text: "Have $50K insurance. Okay?", quality: "fail", analytics: "❌ Недостаточно!", path: "reject_insurance_final" },
                    { text: "No tracking. Driver calls.", quality: "fail", analytics: "❌ Нет tracking!", path: "reject_weak_final" }
                ]
            },
            {
                brokerQuestion: "Appointment Wednesday 2 PM New York. Furniture store - strict. Can you commit?",
                dispatcherPrompt: "💎 Брокер требует commitment на Wednesday 2 PM!",
                suggestions: [
                    { text: "Absolutely committed to Wednesday 2 PM! Based on 1,280 miles, depart tomorrow 9 AM, arrive Wednesday morning with buffer. Zero tolerance for late.", quality: "good", analytics: "✔️ ХОРОШО! Commitment, расчет времени, buffer, zero tolerance.", path: "master" },
                    { text: "Yes, Wednesday 2 PM works. Will plan accordingly.", quality: "normal", analytics: "⚪ Commitment есть, но без деталей плана.", path: "weak" },
                    { text: "We'll try for Wednesday 2 PM...", quality: "weak", analytics: "⚠️ СЛАБО! 'Try' вместо commitment!", path: "weak" },
                    { text: "Traffic unpredictable. Can't promise.", quality: "aggressive", analytics: "🔴 Отказ commitment!", path: "reject_commitment_final" },
                    { text: "Driver will try his best.", quality: "fail", analytics: "❌ Нет гарантии!", path: "reject_commitment_final" },
                    { text: "Maybe Wednesday, maybe Thursday.", quality: "fail", analytics: "❌ Нет commitment!", path: "reject_commitment_final" }
                ]
            },
            {
                brokerQuestion: "Okay, I'll give you one chance. Rate is $2,600 - posted. No premium for uncertainty. Text me every 6 hours with location. Deal?",
                dispatcherPrompt: "💎 Брокер дает шанс но БЕЗ премии. Примите $2,600!",
                suggestions: [
                    { text: "Deal! $2,600 accepted. I'll text you every 6 hours with location. Thank you for the chance - we won't let you down. What's your cell number?", quality: "good", analytics: "✔️ ХОРОШО! Принял условия, благодарность, commitment.", path: "weak_success" },
                    { text: "$2,600 works. Will send updates every 6 hours.", quality: "normal", analytics: "⚪ Принял условия.", path: "weak_success" },
                    { text: "Okay, $2,600...", quality: "weak", analytics: "⚠️ Слабое принятие.", path: "weak_success" },
                    { text: "Can you do $2,700 at least?", quality: "fail", analytics: "❌ Торгуется после слабости!", path: "reject_weak_final" },
                    { text: "Every 6 hours is too much...", quality: "aggressive", analytics: "🔴 Отказ от условий!", path: "reject_weak_final" },
                    { text: "I need more than posted rate.", quality: "fail", analytics: "❌ Жадность!", path: "reject_weak_final" }
                ]
            },
            {
                brokerResponse: "Okay. $2,600 booked. My cell 555-9999. Text every 6 hours with location. Don't be late - this is your only shot with me.",
                outcome: {
                    type: "success",
                    quality: "normal",
                    rate: "$2,600",
                    ratePerMile: "$2.03/mile",
                    relationship: "neutral",
                    feedback: `✅ УСПЕХ БЕЗ ПРЕМИИ. Заработали posted rate ($2,600).\n\n💰 ФИНАНСЫ:\n• Ставка: $2,600\n• Дизель: -$512\n• Чистая прибыль: $2,088\n\n⚠️ УРОК: Неуверенность стоит денег! Потеряли $250 премии из-за слабых ответов. Брокер дал шанс, но без доверия = без премиальной ставки.\n\n💡 ВЫВОД: Всегда отвечайте уверенно с первого раза! "We'll try" и "should be" = красные флаги для брокеров.`
                }
            }
        ],
        ...
        weak_success: [
            {
                ...
                dispatcherPrompt: "💎 Брокер просит email!",
                suggestions: [
                    { text: "dispatch@homefreight.com. I'll sign in 2 hours.", quality: "good", analytics: "✔️ Email и timing.", path: "weak_success" },
                    { text: "dispatch@homefreight.com.", quality: "normal", analytics: "⚪ Только email.", path: "weak_success" },
                    { text: "Let me find email...", quality: "weak", analytics: "⚠️ Не знает email!", path: "weak_success" },
                    { text: "Send to any email.", quality: "fail", analytics: "❌ Непрофессионально!", path: "reject_email_final" },
                    { text: "No email. By phone?", quality: "fail", analytics: "❌ Нет email!", path: "reject_email_final" },
                    { text: "I'll give email later.", quality: "fail", analytics: "❌ Откладывает!", path: "reject_email_final" }
                ]
            }
        ],
        ...
        warning: [
            {
                brokerQuestion: "I understand you're busy, but furniture requires verification. I need to verify your company and van capability for insurance. Standard for all furniture carriers. Can you provide MC and confirm lift gate + air-ride? Critical for both of us.",
                dispatcherPrompt: "⚠️ ПРЕДУПРЕЖДЕНИЕ! Второй шанс - дайте MC и подтвердите equipment!",
                suggestions: [
                    { text: "You're absolutely right, I apologize. MC 445566, HomeFreight Logistics. 30 dry vans with lift gates and air-ride, 3 years furniture experience. Van in Miami, ready 9 AM. Where's pickup?", quality: "good", analytics: "✔️ ИСПРАВИЛСЯ! MC, компания, fleet с equipment, опыт, местоположение, вопрос.", path: "master" },
                    { text: "Sorry. MC 445566, HomeFreight Logistics. Van in Miami with lift gate and air-ride.", quality: "normal", analytics: "⚪ MC, компания, местоположение, equipment.", path: "master" },
                    { text: "MC 445566... have vans...", quality: "weak", analytics: "⚠️ Слабо, нет деталей!", path: "weak" },
                    { text: "I don't have MC right now...", quality: "fail", analytics: "❌ Нет MC!", path: "reject_early_final" },
                    { text: "Just send load info!", quality: "aggressive", analytics: "🔴 Грубость!", path: "reject_early_final" },
                    { text: "Why so difficult?", quality: "fail", analytics: "❌ Жалобы!", path: "reject_early_final" }
                ]
            }
        ],

        // ВСЕ REJECT ПУТИ - ТОЛЬКО ФИНАЛЬНЫЕ OUTCOMES!

        reject_early_final: [
            {
                brokerResponse: "I need professional carriers who understand furniture requirements. Thanks.",
                outcome: {
                    type: "failure",
                    quality: "fail",
                    rate: "$0",
                    feedback: "❌ ОТКАЗ: Непрофессионализм после предупреждения! Furniture loads требуют серьезного подхода с первых секунд."
                }
            }
        ],
...
allScenarios.push(scenario19);
console.log('✅ Scenario 19 loaded: Dry Van Furniture (Miami → New York) - ПРАВИЛЬНЫЙ ФОРМАТ!');
