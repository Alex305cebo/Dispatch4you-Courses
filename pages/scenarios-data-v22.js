// DIALOGUE #22 - Reefer Produce (ПРОВЕРЕНО - БЕЗ ТУПИКОВ!)
...
console.log('🔵 Loading scenarios-data-v22.js...');
        ...
        master: [
            {
                ...
                suggestions: [
                    ...
                    { text: "MC 445566... some reefers...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
                    { text: "Why all details? Tell me rate!", quality: "aggressive", analytics: "🔴 Агрессивно!", path: "reject_attitude_final" },
                    { text: "Reefer available.", quality: "fail", analytics: "❌ Провал!", path: "reject_attitude_final" }
                ]
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should be in Phoenix... serviced...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Driver has some produce experience...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have $100K...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "We'll send updates...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "We'll try for Saturday 8 AM...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have equipment...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have monitoring...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "I think can find references...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Standard detention... flexible payment...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "FSC should be included...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Should have backup...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "$3,300 for this load?", quality: "weak", analytics: "⚠️ Слабо! $100 больше.", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Okay, $3,400...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Okay, $3,450...", quality: "weak", analytics: "⚠️ Слабо.", path: "reject_weak_final" },
            ...
            },
            {
                ...
                suggestions: [
                    ...
                    { text: "Let me find email...", quality: "weak", analytics: "⚠️ Слабо!", path: "reject_weak_final" },
...
allScenarios.push(scenario22);
console.log('✅ Scenario 22 loaded: Reefer Produce (Phoenix → Seattle) - NO DEAD ENDS!');
